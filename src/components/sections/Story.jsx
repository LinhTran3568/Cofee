    ...
    >
      ...
      >
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr_0.9fr] items-start">
          <div className="space-y-5">
            ...
            <p className="text-xl md:text-2xl text-[#5C4033] leading-relaxed text-justify">{intro.insight}</p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <motion.div 
          ...
          className="glass-panel-clear p-8 md:p-12 rounded-3xl h-full flex flex-col"
        >
          ...
          <p className="text-xl md:text-2xl text-[#4A3219] font-medium leading-relaxed mt-auto text-justify">{farmer.description}</p>
        </motion.div>
      </div>
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-[#4A3219] font-medium leading-relaxed mt-auto text-justify">{retail.description}</p>
        </motion.div>
      </div>
      </div>
    </motion.section>
